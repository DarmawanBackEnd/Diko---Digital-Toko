// Service layer pengelolaan Katalog Menu (Produk, Kategori, Varian) di Aplikasi Kasir Diko
// Mendukung persistensi lokal (localStorage) dan tersinkronisasi dengan Backoffice
